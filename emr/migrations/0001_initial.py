# Generated by Django 4.2.7 on 2023-12-17 06:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_id', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='emr.customuser')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='chart',
            name='patient',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='medical_person_identity', to='emr.patientidentity'),
        ),
        migrations.AddField(
            model_name='chart',
            name='treatment',
